...
- 每书写作风格：工作台的“文风”页可为当前小说编辑完整写作风格 Prompt，并提供沉浸式叙事、克制悬疑、黑色幽默等可继续修改的预设；各书独立保存，并自动用于大纲、章节与校验。
...
2. 进入工作台后打开“文风”页，为这一本书粘贴或编辑完整写作风格 Prompt；可用预设作为起点。保存后，它会自动带入后续 AI 大纲、正文与校验任务。
