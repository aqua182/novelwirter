...
export type Timeline = { id:number; time_description:string; location:string; content:string; participants:string; source_chapter_id?:number; confirmed:boolean; is_stale:boolean }
